...
*/
BristolInstrumentsInterface::BristolInstrumentsInterface()
{
    ...
    setObjectName("BristolInstruments");

    m_description = QObject::tr("BristolInstruments");

    //for the docstring, please don't set any spaces at the beginning of the line.
    char docstring[] = \
"BristolInstruments is an itom-plugin, which can be used to communicate with the Bristol Instruments Laser Spectrum Analyzer. \n\
\n\
It has been tested with the 771 series of the spectrum analyzers.\
The communication uses the Telnet SCPI interface via Qt and QTcpSocket.";
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstrumentsInterface::getAddInInst(ito::AddInBase **addInInst)
{
    NEW_PLUGININSTANCE(BristolInstruments) //the argument of the macro is the classname of the plugin
    return ito::retOk;
}

//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstrumentsInterface::closeThisInst(ito::AddInBase **addInInst)
{
   REMOVE_PLUGININSTANCE(BristolInstruments) //the argument of the macro is the classname of the plugin
   return ito::retOk;
}
...
*/
BristolInstruments::BristolInstruments() : AddInGrabber(), m_isgrabbing(false)
{
    ito::Param paramVal("name", ito::ParamBase::String | ito::ParamBase::Readonly, "BristolInstruments", NULL);
    ...
    DockWidgetBristolInstruments *dw = new DockWidgetBristolInstruments(this);
...
//----------------------------------------------------------------------------------------------------------------------------------
BristolInstruments::~BristolInstruments()
{
    if (m_bristolSCPI)
    {
        delete m_bristolSCPI;
    }
}
...
/*!
    \sa close
*/
ito::RetVal BristolInstruments::init(QVector<ito::ParamBase> *paramsMand, QVector<ito::ParamBase> *paramsOpt, ItomSharedSemaphore *waitCond)
{
    ...
    try
    {
        m_bristolSCPI = new BristolSCPI();
    }
    catch (...)
    {
        retValue += ito::RetVal(ito::retError, 0, tr("Cannot create BristolSCPI instance.").toLatin1().data());
    }
    
    if (!retValue.containsError());
    {
        m_bristolSCPI->startBuffer();
        m_bristolSCPI->getEndWL();
    }
...
/*!
    \sa init
*/
ito::RetVal BristolInstruments::close(ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstruments::getParam(QSharedPointer<ito::Param> val, ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue;
    QString key;
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstruments::setParam(QSharedPointer<ito::ParamBase> val, ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
    QString key;
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstruments::startDevice(ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstruments::stopDevice(ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstruments::acquire(const int trigger, ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
    bool RetCode = false;
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal BristolInstruments::retrieveData(ito::DataObject *externalDataObject)
{
...
/*ito::RetVal BristolInstruments::checkData(ito::DataObject *externalDataObject)
{
    return ito::retOk;
}*/
...
*/
ito::RetVal BristolInstruments::getVal(void *vpdObj, ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
...
*/
ito::RetVal BristolInstruments::copyVal(void *vpdObj, ItomSharedSemaphore *waitCond)
{
    ItomSharedSemaphoreLocker locker(waitCond);
    ito::RetVal retValue(ito::retOk);
    ito::DataObject *dObj = reinterpret_cast<ito::DataObject *>(vpdObj);
...
*/
void BristolInstruments::dockWidgetVisibilityChanged(bool visible)
{
    if (getDockWidget())
    {
...
/*!
    ...
    \sa hasConfDialog
*/
const ito::RetVal BristolInstruments::showConfDialog(void)
{
    return apiShowConfigurationDialog(this, new DialogBristolInstruments(this));
}