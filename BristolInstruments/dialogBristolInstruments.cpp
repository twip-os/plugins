...
//----------------------------------------------------------------------------------------------------------------------------------
DialogBristolInstruments::DialogBristolInstruments(ito::AddInBase *grabber) :
...
//----------------------------------------------------------------------------------------------------------------------------------
void DialogBristolInstruments::parametersChanged(QMap<QString, ito::Param> params)
{
...
//----------------------------------------------------------------------------------------------------------------------------------
ito::RetVal DialogBristolInstruments::applyParameters()
{
...
//---------------------------------------------------------------------------------------------------------------------
void DialogBristolInstruments::on_buttonBox_clicked(QAbstractButton* btn)
{
    ito::RetVal retValue(ito::retOk);
...
//---------------------------------------------------------------------------------------------------------------------
void DialogBristolInstruments::enableDialog(bool enabled)
{
    //e.g.
