...
#ifndef BRISTOLINSTRUMENTS_H
#define BRISTOLINSTRUMENTS_H

#include "common/addInGrabber.h"
#include <qsharedpointer.h>
#include "dialogBristolInstruments.h"

#include <bristolscpi.h>

//----------------------------------------------------------------------------------------------------------------------------------
 /**
  *\class    BristolInstrumentsInterface 
  *
  *\brief    Interface-Class for BristolInstruments-Class
  *
  *    \sa    AddInDataIO, BristolInstruments
  *
  */
class BristolInstrumentsInterface : public ito::AddInInterfaceBase
{
    Q_OBJECT
...
//----------------------------------------------------------------------------------------------------------------------------------
 /**
  *\class    BristolInstruments

  */
class BristolInstruments : public ito::AddInGrabber
{
    Q_OBJECT
    ...
    public:
        friend class BristolInstrumentsInterface;
